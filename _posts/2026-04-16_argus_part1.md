...
|:-----------:|:------------:|:----------:|
| {% include figure.liquid loading="eager" path="argus_blog_assets/delivery2_first.jpg" title="example image" class="img-fluid rounded z-depth-1" %} | {% include figure.liquid loading="eager" path="argus_blog_assets/delivery2_mid.jpg" title="example image" class="img-fluid rounded z-depth-1" %} | {% include figure.liquid loading="eager" path="argus_blog_assets/delivery2_last.jpg" title="example image" class="img-fluid rounded z-depth-1" %} |
...
| First Frame | Middle Frame | Last Frame |
|:-----------:|:------------:|:----------:|
| {% include figure.liquid loading="eager" path="argus_blog_assets/theft_first.jpg" title="example image" class="img-fluid rounded z-depth-1" %} | {% include figure.liquid loading="eager" path="argus_blog_assets/theft_mid.jpg" title="example image" class="img-fluid rounded z-depth-1" %} | {% include figure.liquid loading="eager" path="argus_blog_assets/theft_last.jpg" title="example image" class="img-fluid rounded z-depth-1" %} |
...
>
> {% include figure.liquid loading="eager" path="argus_blog_assets/theft_corrupt.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
...
| First Frame | Middle Frame | Last Frame |
|:-----------:|:------------:|:----------:|
| {% include figure.liquid loading="eager" path="argus_blog_assets/delivery1_first.jpg" title="example image" class="img-fluid rounded z-depth-1" %} | {% include figure.liquid loading="eager" path="argus_blog_assets/delivery1_mid.jpg" title="example image" class="img-fluid rounded z-depth-1" %} | {% include figure.liquid loading="eager" path="argus_blog_assets/delivery1_last.jpg" title="example image" class="img-fluid rounded z-depth-1" %} |
