...
*In [Part 2](https://ahfs.github.io/research-notes/blog/2026/adk-vs-cli-2/), we rebuild Sentinel as a CLI agent using Claude Code, Gemini CLI, and opencode, and explore what it means when the LLM is the top-level reasoning process instead of a component your code calls.*
